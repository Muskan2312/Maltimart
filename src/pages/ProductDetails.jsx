        ...
        <Row>
          ...
          <Col lg='6'>
            <div className="product__details">
             ...
             <div className="d-flex align-items-center gap-5"> <span className="product__price">${price}</span>
             <span>Category: {category.toUpperCase}</span></div>
          ...
          <div className="review__wrapper">
               ...
               {reviews?.map((item, index) => (
                 <li key={index} className='mb-4'>
                  <h6>seher shaikh</h6>
                   <div className="average-rating">{avgRating}(rating)</div>
                   <p>{item.text}</p>
                 </li>
               ))}
             </ul>
